...
--
-- Table structure for table `acce_rol`
--

DROP TABLE IF EXISTS `acce_rol`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acce_rol` (
  `id_acce_rol` int(2) NOT NULL AUTO_INCREMENT,
  `acce_id` int(2) NOT NULL,
  `id_rol` int(2) NOT NULL,
  PRIMARY KEY (`id_acce_rol`),
  KEY `acce_id` (`acce_id`),
  KEY `id_rol` (`id_rol`),
  CONSTRAINT `acce_rol_ibfk_1` FOREIGN KEY (`id_rol`) REFERENCES `rol` (`id_rol`) ON UPDATE CASCADE,
  CONSTRAINT `acce_rol_ibfk_2` FOREIGN KEY (`acce_id`) REFERENCES `acceso` (`acce_id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `acce_rol`
--

LOCK TABLES `acce_rol` WRITE;
/*!40000 ALTER TABLE `acce_rol` DISABLE KEYS */;
INSERT INTO `acce_rol` VALUES (3,1,1),(4,5,3);
/*!40000 ALTER TABLE `acce_rol` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `acceso` (
  `acce_id` int(2) NOT NULL AUTO_INCREMENT,
  `usua_id` int(2) NOT NULL,
  `tienda_id` int(2) NOT NULL,
  PRIMARY KEY (`acce_id`),
  KEY `usua_id` (`usua_id`),
  KEY `tienda_id` (`tienda_id`),
  CONSTRAINT `acceso_ibfk_1` FOREIGN KEY (`tienda_id`) REFERENCES `tiendas` (`tienda_id`) ON UPDATE CASCADE,
  CONSTRAINT `acceso_ibfk_2` FOREIGN KEY (`usua_id`) REFERENCES `usuarios` (`id`) ON UPDATE CASCADE
...
INSERT INTO `acceso` VALUES (1,1,1),(2,1,2),(5,2,1),(6,5,2),(7,1,1);
...
CREATE TABLE `arrendatarios` (
  `id_arrendatario` int(2) NOT NULL AUTO_INCREMENT,
  `nombre_arrendatario` varchar(20) NOT NULL,
  `id_propietario` int(2) NOT NULL,
  `id_apartamento` int(2) NOT NULL,
  `apellido_arrendatario` varchar(20) NOT NULL,
  `telefono` varchar(20) NOT NULL,
  `correo_arrendatario` varchar(30) NOT NULL,
  PRIMARY KEY (`id_arrendatario`),
  KEY `id_propietario` (`id_propietario`),
  KEY `id_apartamento` (`id_apartamento`),
  CONSTRAINT `arrendatarios_ibfk_1` FOREIGN KEY (`id_apartamento`) REFERENCES `apartamentos` (`id_apartamento`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `arrendatarios_ibfk_2` FOREIGN KEY (`id_propietario`) REFERENCES `propietarios` (`id_propietario`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `arrendatarios` VALUES (1,'veneco1',1,1,'MalaPaga','5241245','nopaganunca@yahoo.es'),(2,'veneco 2',1,1,'esposa','000000','notiene@gmail.com'),(3,'paisa',2,3,'yuca','00020002','knasdla@gmail.com');
/*!40000 ALTER TABLE `arrendatarios` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aux_accerol_cliente`
--

DROP TABLE IF EXISTS `aux_accerol_cliente`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aux_accerol_cliente` (
  `id_aux_accerol_cliente` int(2) NOT NULL AUTO_INCREMENT,
  `id_acce_rol` int(2) NOT NULL,
  `id_cliente` int(2) NOT NULL,
  PRIMARY KEY (`id_aux_accerol_cliente`),
  KEY `id_acce_rol` (`id_acce_rol`),
  KEY `id_cliente` (`id_cliente`),
  CONSTRAINT `aux_accerol_cliente_ibfk_1` FOREIGN KEY (`id_acce_rol`) REFERENCES `acce_rol` (`id_acce_rol`) ON UPDATE CASCADE,
  CONSTRAINT `aux_accerol_cliente_ibfk_2` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id_cliente`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `aux_accerol_cliente`
--

LOCK TABLES `aux_accerol_cliente` WRITE;
/*!40000 ALTER TABLE `aux_accerol_cliente` DISABLE KEYS */;
INSERT INTO `aux_accerol_cliente` VALUES (1,3,1),(2,4,2);
/*!40000 ALTER TABLE `aux_accerol_cliente` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aux_accerol_empleado`
--

DROP TABLE IF EXISTS `aux_accerol_empleado`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aux_accerol_empleado` (
  `id_aux_accerol_empleado` int(2) NOT NULL AUTO_INCREMENT,
  `id_acce_rol` int(2) NOT NULL,
  `id_empleado` int(2) NOT NULL,
  PRIMARY KEY (`id_aux_accerol_empleado`),
  KEY `id_acce_rol` (`id_acce_rol`),
  KEY `id_empleado` (`id_empleado`),
  CONSTRAINT `aux_accerol_empleado_ibfk_1` FOREIGN KEY (`id_acce_rol`) REFERENCES `acce_rol` (`id_acce_rol`) ON UPDATE CASCADE,
  CONSTRAINT `aux_accerol_empleado_ibfk_2` FOREIGN KEY (`id_empleado`) REFERENCES `empleados` (`id_empleado`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `aux_accerol_empleado`
--

LOCK TABLES `aux_accerol_empleado` WRITE;
/*!40000 ALTER TABLE `aux_accerol_empleado` DISABLE KEYS */;
INSERT INTO `aux_accerol_empleado` VALUES (1,3,3),(2,4,29);
/*!40000 ALTER TABLE `aux_accerol_empleado` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aux_apar_prop`
--

DROP TABLE IF EXISTS `aux_apar_prop`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aux_apar_prop` (
  `id_aux_apar_prop` int(2) NOT NULL AUTO_INCREMENT,
  `id_apartamento` int(2) NOT NULL,
  `id_propietario` int(2) NOT NULL,
  PRIMARY KEY (`id_aux_apar_prop`),
  KEY `id_apartamento` (`id_apartamento`),
  KEY `id_propietario` (`id_propietario`),
  CONSTRAINT `aux_apar_prop_ibfk_1` FOREIGN KEY (`id_apartamento`) REFERENCES `apartamentos` (`id_apartamento`) ON UPDATE CASCADE,
  CONSTRAINT `aux_apar_prop_ibfk_2` FOREIGN KEY (`id_propietario`) REFERENCES `propietarios` (`id_propietario`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `aux_apar_prop`
--

LOCK TABLES `aux_apar_prop` WRITE;
/*!40000 ALTER TABLE `aux_apar_prop` DISABLE KEYS */;
INSERT INTO `aux_apar_prop` VALUES (1,1,1),(2,2,1),(3,3,2),(4,4,4);
/*!40000 ALTER TABLE `aux_apar_prop` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aux_empl_tiend`
--

DROP TABLE IF EXISTS `aux_empl_tiend`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aux_empl_tiend` (
  `id_aux_empl_tiend` int(2) NOT NULL AUTO_INCREMENT,
  `id_empleado` int(2) NOT NULL,
  `tienda_id` int(2) NOT NULL,
  PRIMARY KEY (`id_aux_empl_tiend`),
  KEY `id_empleado` (`id_empleado`),
  KEY `tienda_id` (`tienda_id`),
  CONSTRAINT `aux_empl_tiend_ibfk_1` FOREIGN KEY (`id_empleado`) REFERENCES `empleados` (`id_empleado`),
  CONSTRAINT `aux_empl_tiend_ibfk_2` FOREIGN KEY (`tienda_id`) REFERENCES `tiendas` (`tienda_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `aux_empl_tiend`
--

LOCK TABLES `aux_empl_tiend` WRITE;
/*!40000 ALTER TABLE `aux_empl_tiend` DISABLE KEYS */;
INSERT INTO `aux_empl_tiend` VALUES (1,3,2),(2,4,2),(3,7,2),(4,15,1);
/*!40000 ALTER TABLE `aux_empl_tiend` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `aux_perfiles_menus` VALUES (1,1,1),(2,1,2),(3,1,3),(4,1,4),(5,1,5),(6,1,6),(7,1,7),(8,1,8),(9,1,9),(10,1,10),(11,1,11),(12,1,12),(13,1,13),(14,1,14),(15,2,12),(16,2,13),(17,2,14),(18,3,7),(20,1,15),(21,1,16),(22,1,17),(23,1,18),(24,1,21),(25,1,33),(26,9,33),(27,1,34),(28,9,35),(29,9,38),(30,9,39),(31,9,40),(32,9,41),(33,9,42),(34,9,43),(35,9,44),(36,9,45),(37,9,46),(38,9,47),(39,10,48),(40,9,49);
/*!40000 ALTER TABLE `aux_perfiles_menus` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aux_prop_masc`
--

DROP TABLE IF EXISTS `aux_prop_masc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `aux_prop_masc` (
  `id_aux_prop_masc` int(2) NOT NULL AUTO_INCREMENT,
  `id_propiertario` int(2) NOT NULL,
  `id_mascota` int(11) NOT NULL,
  PRIMARY KEY (`id_aux_prop_masc`),
  KEY `id_propiertario` (`id_propiertario`),
  KEY `id_mascota` (`id_mascota`),
  CONSTRAINT `aux_prop_masc_ibfk_1` FOREIGN KEY (`id_propiertario`) REFERENCES `propietarios` (`id_propietario`) ON UPDATE CASCADE,
  CONSTRAINT `aux_prop_masc_ibfk_2` FOREIGN KEY (`id_mascota`) REFERENCES `mascotas` (`id_mascota`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `aux_prop_masc`
--

LOCK TABLES `aux_prop_masc` WRITE;
/*!40000 ALTER TABLE `aux_prop_masc` DISABLE KEYS */;
INSERT INTO `aux_prop_masc` VALUES (1,1,1),(2,3,2);
/*!40000 ALTER TABLE `aux_prop_masc` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `banners` VALUES (1,'Banner 1','ob 1',10,2,1),(2,'Banner 2','ob 2',15,3,2),(3,'Banner 3','ob 3',12,1,1),(4,'Banner 4','ob 4',14,5,3),(5,'Banner 5','ob 5',16,4,4),(6,'Banner 6','ob 6',18,2,5),(7,'Banner 7','ob 7',12,4,7),(8,'Banner 8','ob 8',14,5,9),(9,'Banner 9','ob 9',19,4,1),(10,'Banner 10','ob 10',11,3,2),(11,'Banner Nuevo','ob new',0,0,0),(12,'banner 11','nuevo',30,10,0),(13,'nuevo banner','bna',20,10,2);
...
CREATE TABLE `bloques` (
  `id_bloque` int(2) NOT NULL AUTO_INCREMENT,
  `id_apartamento` int(2) NOT NULL,
  `nombre_bloque` varchar(30) NOT NULL,
  PRIMARY KEY (`id_bloque`),
  KEY `id_apartamento` (`id_apartamento`),
  CONSTRAINT `bloques_ibfk_1` FOREIGN KEY (`id_apartamento`) REFERENCES `apartamentos` (`id_apartamento`) ON UPDATE CASCADE
...
INSERT INTO `bloques` VALUES (1,1,'bloque 1'),(2,2,'bloque 1'),(3,3,'bloque 1'),(4,4,'bloque 1'),(5,8,'bloque 1'),(6,10,'bloque 1'),(7,11,'bloque 1'),(8,13,'bloque 1'),(9,14,'bloque 1'),(10,15,'bloque 1'),(11,16,'bloque 1'),(12,17,'bloque 1'),(13,18,'bloque 1'),(14,34,'bloque 1'),(15,20,'bloque 2'),(16,21,'bloque 2'),(17,22,'bloque 2'),(18,23,'bloque 2'),(19,24,'bloque 2'),(20,25,'bloque 2'),(21,26,'bloque 2'),(22,27,'bloque 2'),(23,28,'bloque 2'),(24,29,'bloque 2'),(25,30,'bloque 2'),(26,31,'bloque 2'),(27,29,'bloque 2'),(28,30,'v'),(29,31,'bloque 2'),(30,32,'bloque 2'),(31,33,'bloque 2'),(32,34,'bloque 2'),(33,35,'bloque 3'),(34,36,'bloque 3'),(35,37,'bloque 3'),(36,38,'bloque 3'),(37,39,'bloque 3'),(38,40,'bloque 3'),(39,41,'bloque 3'),(40,42,'bloque 3'),(41,43,'bloque 3'),(42,44,'bloque 3'),(43,45,'bloque 3'),(44,46,'bloque 3'),(64,47,'bloque 3'),(65,48,'bloque 3'),(66,49,'bloque 3'),(67,50,'bloque 4'),(68,51,'bloque 4'),(69,52,'bloque 4'),(70,53,'bloque 4'),(71,54,'bloque 4'),(72,55,'bloque 4'),(73,56,'bloque 4'),(74,57,'bloque 4'),(75,58,'bloque 4'),(76,59,'bloque 4'),(77,60,'bloque 4'),(78,61,'bloque 4'),(79,62,'bloque 4'),(80,63,'bloque 4'),(81,64,'bloque 4');
...
INSERT INTO `empleados` VALUES (2,1101,'Boyaca','alberto','sanchez','2019-02-28','masculino','guarda','2019-07-08 00:58:21'),(3,1102,'Antioquia','ana','sanchez','2019-02-06','femenino','diseñadora','2019-07-08 00:58:36'),(4,1103,'Caldaz','Andrea','Corzo','2019-02-03','femenino','Programadora Junior','2019-07-08 00:58:48'),(7,1104,'Risaralda','Andres','Cardenas','2019-07-06','masculino','Operador','2019-07-06 05:00:00'),(13,1106,'Bogota','Antonela','Giraldo','2019-01-07','masculino','Operador','2019-07-07 05:00:00'),(15,1107,'Antioquia','mmmmmmmm','Garcia','1992-02-20','masculino','Auditor','2019-07-07 05:00:00'),(29,1109,'Bogota','benito','Perez','1997-08-06','masculino','Operador','0000-00-00 00:00:00'),(30,1104,'Boyaca','Antonela','Cardenas','2019-07-10','masculino','Operador','2019-10-08 04:50:48'),(33,2147483647,'Bogota','edit nuevo julio','asda','2019-07-09','femenino','Operador','2019-04-08 00:58:48'),(34,2147483647,'Bogota','Antonela','asda','0000-00-00','masculino','guarda','2019-05-08 02:50:48'),(35,123456,'Bogota','Andres Fransisco','Cardenas Ruiz','1992-04-25','masculino','Operador','0000-00-00 00:00:00'),(36,11111,'Boyaca','Andres','Cardenas','2019-07-11','masculino','Operador','0000-00-00 00:00:00');
...
CREATE TABLE `interiores` (
  `interior_id` int(2) NOT NULL AUTO_INCREMENT,
  `id_bloque` int(2) NOT NULL,
  `nombre_interior` varchar(20) NOT NULL,
  PRIMARY KEY (`interior_id`),
  KEY `id_bloque` (`id_bloque`),
  CONSTRAINT `interiores_ibfk_1` FOREIGN KEY (`id_bloque`) REFERENCES `bloques` (`id_bloque`) ON UPDATE CASCADE
...
INSERT INTO `interiores` VALUES (1,1,'interior 1'),(2,2,'interior 1'),(3,3,'interior 1'),(4,4,'interior 1'),(5,5,'interior 1'),(6,6,'interior 1'),(7,7,'interior 1'),(8,8,'interior 1'),(9,9,'interior 1'),(10,10,'interior 1'),(11,11,'interior 1'),(12,12,'interior 1'),(13,13,'interior 1'),(14,14,'interior 1'),(15,15,'interior 1'),(16,19,'interior 1'),(17,17,'interior 1'),(18,18,'interior 1'),(19,19,'interior 1'),(20,20,'interior 1'),(21,21,'interior 1'),(22,22,'interior 1'),(23,23,'interior 1'),(24,24,'interior 1'),(25,25,'interior 1'),(26,26,'interior 1'),(27,27,'interior 1'),(28,28,'interior 1'),(29,29,'interior 1'),(30,30,'interior 1'),(31,31,'interior 1'),(32,32,'interior 1'),(33,33,'interior 2'),(34,34,'interior 2'),(35,35,'interior 2'),(36,36,'interior 2'),(37,37,'interior 2'),(38,38,'interior 2'),(39,39,'interior 2'),(40,40,'interior 2'),(41,41,'interior 2'),(42,42,'interior 2'),(43,43,'interior 2'),(44,44,'interior 2'),(45,64,'interior 2'),(46,65,'interior 2'),(47,66,'interior 2'),(48,67,'interior 2'),(49,68,'interior 2'),(50,69,'interior 2'),(51,70,'interior 2'),(52,71,'interior 2'),(53,72,'interior 2'),(54,73,'interior 2'),(55,74,'interior 2'),(56,75,'interior 2'),(57,76,'interior 2'),(58,77,'interior 2'),(59,78,'interior 2'),(60,79,'interior 2'),(61,80,'interior 2'),(62,81,'interior 2');
...
CREATE TABLE `mascotas` (
  `id_mascota` int(2) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `mascotas` VALUES (1,'budy','P','M','E05','B'),(2,'Pipo','P','M','E02','A'),(3,'Nuna','P','H','E03','A'),(4,'Bruts','P','M','E03','A'),(5,'Americo','G','M','E04','A'),(6,'Sombra','P','H','E05','A'),(7,'Amaya','P','H','E04','A'),(8,'Talia','G','H','E01','B'),(9,'Trabis','P','H','E02','A'),(10,'Tesa','G','M','E01','A'),(11,'Titito','G','M','E04','B'),(12,'Truca','P','H','E02','A'),(13,'Dandi','G','M','E04','A'),(14,'RAS','G','M','E01','A'),(15,'Canela','P','H','E02','A');
...
INSERT INTO `menus` VALUES (1,'Admón Usuarios','adm_usuarios','<i class=\"fa fa-address-card\"></i>','admon-usuarios'),(2,'Admón Menús','adm_menus','<i class=\"fa fa-amazon\"></i>','admon-menus'),(3,'Admón Perfiles','adm_perfiles','<i class=\"fa fa-cogs\"></i>','admon-perfiles'),(4,'Admón Clientes','adm_clientes','<i class=\"fa fa-desktop\"></i>','admon-clientes'),(5,'Admón Banners','adm_banners','<i class=\"fa fa-bed\"></i>','admon-banners'),(6,'Estadísticas Banners','estadisticas_banners','<i class=\"fa fa-ban\"></i>','estadisticas-banners'),(7,'Admón Visitantes','adm_visitantes','<i class=\"fa fa-amazon\"></i>','admon-visitantes'),(8,'Admón Propietarios','adm_propietario','<i class=\"fa fa-amazon\"></i>','admon-propietario'),(9,'Admón Residentes','adm_residentes','<i class=\"fa fa-amazon\"></i>','admon-residentes'),(10,'Admon Apartamentos 2','adm_apartamentos','<i class=\"fa fa-amazon\"></i>','admon-apartamentos 2'),(11,'Admón Interiores','adm_interiores','<i class=\"fa fa-amazon\"></i>','admon_interiores'),(12,'Admon Eventos','adm_eventos','<i class=\"fa fa-amazon\"></i>','admon-eventos'),(13,'Admón Reservas','adm_reservas','<i class=\"fa fa-amazon\"></i>','admon_reservas'),(14,'Admón Correspondencia','adm_correspondencia','<i class=\"fa fa-amazon\"></i>','admon_correspondencia'),(15,'Admón Videos','adm_videos','<i class=\"fa fa-desktop\"></i>','adm_videos'),(16,'Admón Galeria ','adm_galeria','<i class=\"fa fa-bed\"></i>','adm_galeria'),(17,'adm_galeria_rock','adm_rock','<i class=\"fa fa-address-card\"></i>','adm_rock'),(18,'Admon Pivote','adm_perfiles_menus','<i class=\"fa fa-address-card\"></i>','adm_perfiles_menus'),(21,'menu_tpl','tpl','<i class=\"fa fa-address-book\"></i>','tpl'),(25,'zzzzzzzz','zzzzzz','<i class=\"fa fa-address-card\"></i>','zzzzzz'),(28,'zzzzzzzz','zzzzzz','<i class=\"fa fa-address-card\"></i>','zzzzzz'),(29,'Admón Usuarios','zzzzzz','<i class=\"fa fa-address-book-o\"></i>','zzzzzz'),(30,'Admón Usuarios','zzzzzz','<i class=\"fa fa-address-book-o\"></i>','zzzzzz'),(33,'Cover Page','English_Portfolio_Portada','<i class=\"fa fa-address-card\"></i>','English_Portfolio_Portada'),(34,'pink_floyd','pink_floyd','<i class=\"fa fa-address-card\"></i>','pink_floyd'),(35,'Portfolio Audio','English_Portfolio_Audio','<i class=\"fa fa-music\"></i>','English_Portfolio_Audio'),(38,'Portfolio Audio 2','English_Portfolio_Audio_B','<i class=\"fa fa-music\"></i>','English_Portfolio_Audio_B'),(39,'Portfolio Audio 3','English_Portfolio_Audio_C','<i class=\"fa fa-music\"></i>','English_Portfolio_Audio_C'),(40,'Portfolio Audio 4','English_Portfolio_Audio_D','<i class=\"fa fa-music\"></i>','English_Portfolio_Audio_D'),(41,'Portfolio Audio 5','English_Portfolio_Audio_E','<i class=\"fa fa-music\"></i>','English_Portfolio_Audio_E'),(42,'Movies Porftolio','Movies','<i class=\"fa fa-file-movie-o\"></i>','Movies'),(43,'Movie One','Movies_One','<i class=\"fa fa-file-video-o\"></i>','Movies_One'),(44,'Movie Two','Movies_Two','<i class=\"fa fa-file-video-o\"></i>','Movies_Two'),(45,'Movie Three','Movies_Three','<i class=\"fa fa-file-video-o\"></i>','Movies_Three'),(46,'Movie Four','Movies_Four','<i class=\"fa fa-file-video-o\"></i>','Movies_Four'),(47,'Movie Five','Movies_Five','<i class=\"fa fa-file-video-o\"></i>','Movies_Five'),(48,'Relax Music ','relax_music','<i class=\"fa fa-music\"></i>','relax_music'),(49,'Vocabulary','Vocabulary','<i class=\"far fa-save\"></i>','Vocabulary');
...
INSERT INTO `perfiles` VALUES (1,'administrador'),(2,'cliente'),(3,'guarda'),(5,'nuevo perfilnn'),(7,'jamz'),(9,'U_Tolima'),(10,'Jamz_Music'),(11,'peguelo'),(12,'qweq');
...
INSERT INTO `rol` VALUES (1,'Administrador'),(2,'Empleado'),(3,'Guarda'),(4,'Propietario'),(5,'Arrendatario'),(6,'cliente');
...
CREATE TABLE `tiendas` (
  `tienda_id` int(2) NOT NULL AUTO_INCREMENT,
  `razon_social` varchar(20) NOT NULL,
  `razon_comercial` varchar(30) NOT NULL,
  `nit` int(15) NOT NULL,
...
INSERT INTO `tiendas` VALUES (1,'Prueba SAS','Dulces y Empanadas',830860369),(2,'Natura SAS','Belleza',832145878);
...
INSERT INTO `usuarios` VALUES (1,'administrador Jamz Garcia','admin@conjuntoseguro.com','8ca32d950873fd2b5b34a7d79c4a294b2fd805abe3261beb04fab61a3b4b75609afd6478aa8d34e03f262d68bb09a2ba9d655e228c96723b2854838a6e613b9d','fotos/photo.png',1,1,1),(2,'Andres','prueba1@gmail.com','8ca32d950873fd2b5b34a7d79c4a294b2fd805abe3261beb04fab61a3b4b75609afd6478aa8d34e03f262d68bb09a2ba9d655e228c96723b2854838a6e613b9d','fotos/logon.png',1,2,2),(3,'otrousuario','otrouser@gmail.com','8ca32d950873fd2b5b34a7d79c4a294b2fd805abe3261beb04fab61a3b4b75609afd6478aa8d34e03f262d68bb09a2ba9d655e228c96723b2854838a6e613b9d','fotos/goku.png',1,3,3),(5,'Guarda','guarda@gmail.com','8ca32d950873fd2b5b34a7d79c4a294b2fd805abe3261beb04fab61a3b4b75609afd6478aa8d34e03f262d68bb09a2ba9d655e228c96723b2854838a6e613b9d','fotos/jefe@gmail.com.jpg',1,3,5),(6,'Guarda aaa','new111@gmail.com','8ca32d950873fd2b5b34a7d79c4a294b2fd805abe3261beb04fab61a3b4b75609afd6478aa8d34e03f262d68bb09a2ba9d655e228c96723b2854838a6e613b9d','fotos/new111@gmail.com.jpg',1,5,6),(7,'sin foto','sinfoto@gmail.com','8ca32d950873fd2b5b34a7d79c4a294b2fd805abe3261beb04fab61a3b4b75609afd6478aa8d34e03f262d68bb09a2ba9d655e228c96723b2854838a6e613b9d','',0,3,7),(8,'invitado','invitado@jamzpcs.com','6064a45f5b2714f7d85bd511e4c6a2a1eed3aee452d69bda40290858c17d8771deff1aaa12482fa5d005b1da39f9441c26cb3bb022744b2c2aa5bc69c3913b58','fotos/invitado@jamzpcs.com.jpg',1,2,8),(9,'U_Tolima','u_tolima@ut.edu.co','8ca32d950873fd2b5b34a7d79c4a294b2fd805abe3261beb04fab61a3b4b75609afd6478aa8d34e03f262d68bb09a2ba9d655e228c96723b2854838a6e613b9d','fotos/u_tolima@ut.edu.co.png',1,9,9),(10,'Jamz Music','jamzmusic@jamzonline.com','a8fbc688e0f74694e6e4a5632690c30327af5ee3d948500470df695537eb70b3b8848fff30e53b624eb6f51ad40598b76a2fe93488f8d22b60634535d818df48','fotos/jamzmusic@jamzonline.com.jpg',1,10,10),(11,'guarda11','pinto@asdasa.com','8ca32d950873fd2b5b34a7d79c4a294b2fd805abe3261beb04fab61a3b4b75609afd6478aa8d34e03f262d68bb09a2ba9d655e228c96723b2854838a6e613b9d','fotos/pinto@asdasa.com.jpg',1,3,11);
...
-- Dump completed on 2020-03-07 18:01:44
