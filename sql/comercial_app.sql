...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-04-2020 a las 01:02:27
...
--
-- Estructura de tabla para la tabla `comercial_info`
--

CREATE TABLE `comercial_info` (
  `come_info_id` int(11) NOT NULL,
  `come_info_nombre` varchar(20) NOT NULL,
  `come_info_apellido` varchar(20) NOT NULL,
  `come_info_eps` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `comercial_info`
--

INSERT INTO `comercial_info` (`come_info_id`, `come_info_nombre`, `come_info_apellido`, `come_info_eps`) VALUES
(1, 'Erika', 'Hernandez', 'Sanitas EPS'),
(2, 'Fernando', 'Neira', 'Capital Salud');
...
(18, 'ComercialPrueba', 'ComercialPrueba', '<i class=\"fa fa-address-card\"></i>', 'adm_comercial');
...
(1, 'administrador Jamz Garcia', 'root@comericalapp.com', '8ca32d950873fd2b5b34a7d79c4a294b2fd805abe3261beb04fab61a3b4b75609afd6478aa8d34e03f262d68bb09a2ba9d655e228c96723b2854838a6e613b9d', 'fotos/root@comericalApp.com.jpg', 1, 6),
(7, 'Erika Hernandez', 'erikah@comercialapp.com', '8ca32d950873fd2b5b34a7d79c4a294b2fd805abe3261beb04fab61a3b4b75609afd6478aa8d34e03f262d68bb09a2ba9d655e228c96723b2854838a6e613b9d', 'fotos/erikah@comercialapp.com.jpg', 1, 2),
(8, 'Henry ', 'henry@comercialpp.com', '8ca32d950873fd2b5b34a7d79c4a294b2fd805abe3261beb04fab61a3b4b75609afd6478aa8d34e03f262d68bb09a2ba9d655e228c96723b2854838a6e613b9d', 'fotos/henry@comercialpp.com.jpg', 1, 2),
(9, 'Carlos Mendoza', 'carlosm@comercialapp.com', '5f2e6e4fe7035ae7c6de4e68a4acb7e4926e5bbe2594ca79dbf05484273296a071e17ce3a97d1963a135adeecae3acbf1cd3acc0adfb31a6a34f262848bec787', 'fotos/carlosm@comercialapp.com.png', 1, 1);
...
--
-- Indices de la tabla `comercial_info`
--
ALTER TABLE `comercial_info`
  ADD PRIMARY KEY (`come_info_id`);
...
--
-- AUTO_INCREMENT de la tabla `comercial_info`
--
ALTER TABLE `comercial_info`
  MODIFY `come_info_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `iconos`
--
ALTER TABLE `iconos`
  MODIFY `id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=786;

--
-- AUTO_INCREMENT de la tabla `menus`
--
ALTER TABLE `menus`
  MODIFY `id_menu` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de la tabla `perfiles`
--
ALTER TABLE `perfiles`
  MODIFY `id_perfil` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
